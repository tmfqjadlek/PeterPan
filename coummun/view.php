...
<? 
	...
	{
?>
				<a href="write_form.php?table=<?=$table?>&mode=response&num=<?=$num?>&page=<?=$page?>"><!--<img src="../img/response.jpg">-->답변</a>&nbsp;
				<a href="write_form.php?table=<?=$table?>"><img src="../img/write.jpg"></a>
<?
	}
?>
		</div>
		...
		<div id="ripple">
<?
	    $sql = "select * from peterpan_QNA_ripple where parent='$item_num'";
