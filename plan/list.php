...
?>
			<div id="list_item">
				...
				<div id="list_item2"><?=$space?><a href="../plan/view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>"><?= $item_subject ?></a></div>
...
?>			
			&nbsp;&nbsp;&nbsp;&nbsp;다음 ▶
				...
				<div>
					<a href="write_form.php?table=<?=$table?>"><img src="../img/list.png"style="margin-left:0px;"></a>
<? 
	if($id=="admin")
	{
?>
	<a href="write_form.php?table=<?=$table?>&page=<?=$page?>"><img src="../img/wr.png"        ></a>&nbsp;
