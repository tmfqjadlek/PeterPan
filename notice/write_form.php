...
?>
		<div id="write_form">
			...
			<div id="write_row2"><div class="col1"> 제목   </div>
			                     <div class="col2"><input type="text" name="subject" value="<?=$item_subject?>" size="20px"></div>
			</div>
			<div class="write_line"></div>
			<div id="write_row3"><div class="col1" style="height:277px;margin-left:-160px;margin-top:7px;"> 내용   </div>
...
<br>
			...
			<div id="write_row4" style="margin-top:240px"><div class="col1"> 이미지파일1   </div>
...
?>
		...
		<div id="write_button"><a href="#"><img src="../img/save.png" onclick="check_input()"></a>&nbsp;
