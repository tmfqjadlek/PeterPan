...
<body>
	...
	<div class="container">
		...
		<div id="write_form">
			...
			<div class="write_line"></div>
			<div id="write_row3" style="height:277px;margin-top:8px;"><div class="col1" style="height:275px;"> 내용   </div>
		...
		<div id="write_button"><input type="image" src="../img/save.png">&nbsp;
								<a href="list.php?page=<?=$page?>"><img src="../img/list.png" style="margin-top:-28px;"></a>
